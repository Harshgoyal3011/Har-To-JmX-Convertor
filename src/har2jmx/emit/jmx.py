...
def _build_jmx_tree(result: EngineResult, config: dict[str, str] | None = None,
    ...
    # Deterministic plan name: the same HAR must always emit byte-identical JMX (a generation timestamp
    # here made two runs differ across a minute boundary, breaking reproducible output/diffing).
    name = "har2jmx Plan"
