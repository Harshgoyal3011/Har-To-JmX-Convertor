...
from har2jmx.correlations.discover import (
    _inventory_response,
...
from har2jmx.patterns import TOKEN_NAME_RE, ID_FIELD_RE, GUID_RE
...
def _inventory_numeric_ids(index: int, sampler: SamplerModel) -> list[Any]:
    ...
    from har2jmx.correlations.discover import _ResponseValue
