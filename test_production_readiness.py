...
def test_instantiation():
    ...
    try:
        from app.analyzer import AnalyzerEngine, DependencyGraph, AIReviewLayer, ValueOriginClassifier
...
def test_value_origin_classification():
    ...
    from app.analyzer import ValueOriginClassifier, ValueClassification
    from app.models import SamplerModel
